...
| testType                  | Used by the task UI only. Valid options are `app` or `code` or `container` or `command` to manually specify a Snyk CLI command.                                                                                                                                                                                                                                                                                                                                                             | no                           | "app"    | string: "app" or "code" or container"                                             |
...
| command                   | Define the Snyk command to execute. Current permitted commands are: `sbom`, `sbom test`. Flag options can be added via `additionalArugments`.                                                                                                                                                                                                                                                                                                                                               | no                           | none     | string                                                                            |
